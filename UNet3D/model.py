...
from buildingblocks import Encoder, Decoder, FinalConv, DoubleConv, ExtResNetBlock, SingleConv, create_feature_maps
...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, final_sigmoid=True, f_maps=64, layer_order='crg', num_groups=8,
                 **kwargs):
...
class ResidualUNet3D(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, final_sigmoid=True, f_maps=32, conv_layer_order='cge', num_groups=8,
                 **kwargs):
